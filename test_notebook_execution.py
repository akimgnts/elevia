...
print(f"📊 Statistiques des compétences:")
...
if offers_with_skills < len(raw_offers) * 0.1:  # Moins de 10%
...
def parse_salary_range(salaire: Any) -> tuple:
    ...
    return None, None  # Simplification pour le test

try:
    records = []
    for i, o in enumerate(raw_offers[:10]):  # Test sur 10 offres
